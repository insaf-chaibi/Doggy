    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container-fluid">
                <div class="row">
                    <a class="col-3 navbar-brand" href="{{ url('/') }}"><img src="{{ asset('images/doggy.png') }}" width=70%></a>
                ...
                <ul class="col-9 navbar-nav ms-auto">
                    ...
                    @else
                        ...
                        @if (Auth::user())
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/freeConsultation') }}">{{ __('Free consultation') }}</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle shadow-none" id="dropdownMenuButton" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
